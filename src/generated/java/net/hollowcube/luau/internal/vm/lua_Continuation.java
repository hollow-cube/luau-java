...
public class lua_Continuation {
    ...
    public interface Function {
        int apply(MemorySegment L, int status);
    }
    ...
    private static final MethodHandle UP$MH = lua_h.upcallHandle(lua_Continuation.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(lua_Continuation.Function fi, Arena arena) {

...
public class lua_Destructor {
    ...
    public interface Function {
        void apply(MemorySegment L, MemorySegment userdata);
    }
    ...
    private static final MethodHandle UP$MH = lua_h.upcallHandle(lua_Destructor.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(lua_Destructor.Function fi, Arena arena) {
